...
<a href="about-us_gca.php">READMORE </a>
</div>
</div>
<div class="clearfix"></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
				<div class="popup-form">
                	<img src="images/invitation-popup.jpg" class="img-responsive">
                </div>
            </div>
        </div>
    </div>
...
<div id="myModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <img src="images/popup_logo.jpg" alt="">
            </div>
            <div class="modal-body">
                <p>Dear Student,</p>
                <p>Hope you and your family are doing well and keeping safe.</p>
                <p><span>During this vacation period, all your teachers are committed to helping you</span> <span> learn uninterrupted. We hope you will enjoy our unique online modules and</span> <span>programs and stay excited throughout this new learning adventure</span></p>
                <p>Sincerely, - Praneeth. R</p>
                <ul class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                		
                        <li class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        	For Online Classes<br>
                            <a href="http://www.wisewoodsonline.org/" target="_blank">Click Here</a> 
                        </li>
                </ul>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <img src="images/wisewood-posters1.jpg">
