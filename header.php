...
<div class="menu-part">
  <div class="container">
    <div class="col-md-3 col-sm-3 col-xs-6 small-dev-logo">
      <div class="logo-gts">
        <a href="/"><img src="img/GCA-logo.png" alt="logo" class="img-responsive" style="height:92px;"/></a>
      </div>
    </div>
            ...
            <div class="container-fluid no-pad-sd">
              ...
              <div class="collapse navbar-collapse no-pad-sd" id="myNavbar">
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Global Center of Arts  <b class="caret"></b> </a>
