...
<div class="name-profile"> <h2>Mrs. Udhaya Boopathy<span>Assistant Director, Chengalpet & Kancheepuram Districts</span></h2></div>
...
<div class="study-bg ani">
<div class="name-profile"> <h2>Mr. Jayaveerapandian<span>Assistant Director, Krishnagiri District</span></h2> </div>
<div class="col-md-12 no-pad-img border-cont ani">
<div class="border-cont-br border-cont-rightco">
<img src="img/unavailable.jpg" alt="chairman" class="img-responsive"/>
<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
